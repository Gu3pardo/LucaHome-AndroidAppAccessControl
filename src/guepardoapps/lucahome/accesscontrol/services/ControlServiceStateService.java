	...
	private Runnable _checkServices = new Runnable() {
		public void run() {
			...
			if (!isServiceRunning(MainService.class)) {
				...
				ToastView.warning(_context, "MainService not running! Restarting!", Toast.LENGTH_LONG).show();
			...
			if (!isServiceRunning(ReceiverService.class)) {
				...
				ToastView.warning(_context, "ReceiverService not running! Restarting!", Toast.LENGTH_LONG).show();
